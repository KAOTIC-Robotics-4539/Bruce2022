...
public class ClimbRotate extends CommandBase {
    ...
    public ClimbRotate(DoubleSupplier setpoint, ClimberRotate subsystem) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        m_climberRotate = subsystem;
        addRequirements(m_climberRotate);
    ...
    public void execute() {
        ...
        m_climberRotate.my_climberRotate(currentcommand);
