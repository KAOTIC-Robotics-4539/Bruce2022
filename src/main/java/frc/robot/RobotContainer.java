...
// The robot's subsystems
    public final ClimberRotate m_climberRotate = new ClimberRotate();
...
private final XboxController driverContorler = new XboxController(0);
  ...
  */
  private RobotContainer() {
   ...
   m_climberUp.setDefaultCommand(new ClimbRotate(() ->  coDriverControler.getRawAxis(5), m_climberRotate));     
