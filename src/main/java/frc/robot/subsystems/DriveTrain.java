...
private DoubleSolenoid shifter;
    ...
    final double kGear_Low = 26.820;
    final double kGear_High = 12.875;
    ...
    */
    ...
    public void periodic() {
        ...
        SmartDashboard.putBoolean("Is High Gear", my_get_Shifter_isHighGear());
    ...
    public boolean my_get_Shifter_isHighGear() {
    ...
    private double my_getRight_Encoder_Rotations() {
        return rightMaster.getSelectedSensorPosition(0) / kUnitsPerRevolution; /* position units */
    }

    public double my_getRight_Encoder_Distance_Inch() {
        if (my_get_Shifter_isHighGear()) {
            return (my_getRight_Encoder_Rotations() / kGear_High) * (kWheelDiameter * Math.PI);
        } else {
            return (my_getRight_Encoder_Rotations() / kGear_Low) * (kWheelDiameter * Math.PI);
        }
    }
